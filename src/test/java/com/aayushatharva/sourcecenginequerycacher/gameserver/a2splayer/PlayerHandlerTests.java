...
public class PlayerHandlerTests {
    ...
    @Test
    public void testPlayerHandlerMatchingChallenge() {
        ...
        A2S_PLAYER_REQUEST_HEADER.getBytes(0, expectedRequest);
        ...
        assertEquals(CacheHub.A2S_PLAYER.readableBytes(), 0);

        playerHandler.channelRead0(ctx, packet);
    ...
    @Test
    public void testPlayerHandlerMatchingPlayers() {
        var content = allocator.directBuffer()
                .writeBytes(A2S_PLAYER_RESPONSE_HEADER.retainedDuplicate())
        ...
        assertEquals(CacheHub.A2S_PLAYER.readableBytes(), content.readableBytes());
        CacheHub.A2S_PLAYER.getBytes(0, storedContent);
